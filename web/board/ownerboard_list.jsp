...
<script>
function ownerboard_list() {
		<% if(owner != null) { %>
		$.ajax({
			url:"storebyowner.jargo?owner_id="+'<%=owner.getOwner_id() %>',
			dataType:"json",
...
function ownerboard_view(board_number) {
		<% if(owner != null) { %>
		$.ajax({
			...
			success:function(data){
				...
				$("#board_body2").append("</tr>");
					...
					$("#board_body2").append("<table border='0'>");
					$("#board_body2").append("<tr>");
					$("#board_body2").append("<td colspan='4' align='center' style='border: 0px; height: 40px;'><a href='#' id='button_write' onclick='ownerboardDelete(this.form);'>Remove</a>&nbsp;&nbsp;<a href='#' id='button_write' onclick='ownerboard_list();'>List</a></td>");
					$("#board_body2").append("</tr>");
					}
...
<form style="overflow-x: hidden; overflow-y: scroll; height: 320px; position: static;">
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="board_list" id="board_table1">
<!-- ±Û list -->
...
<!-- <table width="100%" cellpadding="0" cellspacing="0" border="0" class="board_list" id="board_table2">
  ...
  <tr align="center">
   <td style="align: center;"><a href="#" id="button_write" onclick="ownerboardWrite('layer3',1); return false;" style="position: fixed;">Write</a></td>
  </tr>
</table> -->
...
<!-- =============================================================================================================== -->
	...
	<%if(owner != null) { %>
		<jsp:include page='../board/ownerboard_delete.jsp' />
	<%} %>
